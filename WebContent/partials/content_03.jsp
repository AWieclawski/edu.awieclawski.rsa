...
<div id="right">
	...
	<div class="calculation">
		...
		<% } %>				
			...
			Encoded from ASCII: <font color="<%=Attributes.RSA_EN_A.getColor()%>"><%= rsaEn_A %></font> with private key <br>
			-- (Transmission channel) -- <br>
			Decoded to ASCII: <font color="<%=Attributes.ASCII_DE_A.getColor()%>"><%= asciiDe_A %></font> with public key  
			<font color="<%=Attributes.PUBLIC_KEY_A.getColor()%>"><%=publicKey_A%></font> <br>
			Received from decoded ASCII: <font color="<%=Attributes.TEXT_DE_A.getColor()%>"><%= textDe_A %></font> with public key 
